-- Fix all subscription status checks to include both 'active' and 'trialing'

-- Update increment_ai_transcription function
...
-- Update increment_ai_natural_input function
...
-- Update get_current_ai_usage function
